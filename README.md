...
[x]  Hold each team's current score in a state value
[x]  Render each team's current score that is in state to the DOM.
[x]  Be able to click the different buttons to increment the appropriate team's score by the correct amount
